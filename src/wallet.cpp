...
bool CWallet::LoadCScript(const CScript& redeemScript)
{
    ...
    if (redeemScript.size() > MAX_SCRIPT_ELEMENT_SIZE)
    {
        ...
        std::string strAddr = CBitcoinAddress(redeemScript.GetID(), PNTS_COLOR_NONE).ToString();
...

    {
        ...
        CTxDB txdb("r");
        {
            ...
            while (true)
            {
                ...
                // change
                //
                // pointcoin: sub-tenth of a cent change is moved to fee
                ...
                // fee delegate change
                //
                // pointcoin: sub-tenth of a cent fee change is moved to fee
...
bool CWallet::UnlockStealthAddresses(const CKeyingMaterial& vMasterKeyIn)
{
    ...
    for (; mi != mapCryptedKeys.end(); ++mi)
    {
        ...
        CBitcoinAddress addr(ckid, PNTS_COLOR_NONE);
...
# if 0
        ...
        if (fDebug)
        {
            ...
            CBitcoinAddress coinAddress(keyID, PNTS_COLOR_NONE);
                                  ...
                                  int64_t nFees[], CTransaction& txMint, CTransaction& txStake, CKey& key)
{
    ...
    // Calculate PoS reward
    {
        ...
        // pointcoin uses block rewards that do not depend on coin age
        uint64_t nCoinAge;
        CTxDB txdb("r");
...
bool CWallet::DelAddressBookName(const CTxDestination& address)
{
    ...
    NotifyAddressBookChanged(this, address, (int) PNTS_COLOR_NONE, "", fOwned, CT_DELETED);
