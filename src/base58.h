...
const int PUBKEY_ADDRESS = 15;      // UP
const int SCRIPT_ADDRESS = 244;       // 8UP
// testnet
const int PUBKEY_ADDRESS_TEST = 29;  // up
const int SCRIPT_ADDRESS_TEST = 4;  // 3UP
...
public:
    ...
    bool SetString(const char *psz)
    {
        ...
        std::string address;
        int nCheckColor = PNTS_COLOR_NONE;
        {
