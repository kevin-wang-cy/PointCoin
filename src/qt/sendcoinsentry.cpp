    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a PointCoin address (e.g. brj6Q4FUHXjAzCRb6SB3pXPfuva5xrfjgHY)"));
...
void SendCoinsEntry::setModel(WalletModel *model)
{
    ...
    {
        connect(model->getOptionsModel(), SIGNAL(displayUnitChangedPointCoin(int)), this,
