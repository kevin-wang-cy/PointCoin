    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("PointCoin") + " " + tr("Wallet"));
    qApp->setStyleSheet("QMainWindow { border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top:15px;padding-bottom:10px;margin:0px; } #spacer { background:rgb(85,0,0);border:none; } #progressBarLabel { color:rgb(255,255,255); padding-top:2px; padding-bottom:2px; padding-right:8px; margin:0px;} #progressBarLabel, #toolbarProgress {background-color: rgb(56,56,56);border:none;} #progressBar {background-color: rgb(128,128,128)} #toolbar3 { border:none;width:1px; background-color: rgb(56,56,56); } #toolbar2 { border:none;width:28px; background-color:rgb(56,56,56); } #toolbar { border:none;height:100%;padding-top:20px; background: rgb(85,0,0); text-align: left; color: white;min-width:150px;max-width:150px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 1, y2: 1,stop: 0 rgb(85,0,0), stop: 1 rgb(212,0,0));} QToolBar QToolButton { font-family:Century Gothic;padding-left:20px;padding-right:150px;padding-top:10px;padding-bottom:10px; width:100%; color: white; text-align: left; background-color: rgb(85,0,0) } #labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center;color:white; } QMenu { background: rgb(85,0,0); color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(85,0,0), stop: 1 rgb(212,0,0)); } QMenuBar { background: rgb(85,0,0); color:white; } QMenuBar::item { font-size:12px;padding-bottom:8px;padding-top:8px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(85,0,0), stop: 1 rgb(212,0,0));}");
#ifndef Q_OS_MAC
    ...
    addressBookPage = new AddressBookPage(AddressBookPage::ForEditing,
                                               AddressBookPage::SendingTab, PNTS_COLOR_NONE);

    receiveCoinsPage = new AddressBookPage(AddressBookPage::ForEditing,
                                               AddressBookPage::ReceivingTab, PNTS_COLOR_NONE);
...
//     tabGroup->addAction(statisticsAction);
    ...
    sendCoinsAction->setToolTip(tr("Send money to a PointCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About PointCoin"), this);
    aboutAction->setToolTip(tr("Show information about PointCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PointCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PointCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PointCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PointCoin network", "", count));
}
...
void BitcoinGUI::askFee(qint64 nFeeRequired, int nColor, bool *payFee)
{
    QString strMessage =
        tr("This transaction requires a fee based on the services it uses. You may send it "
           "for a fee of %1, which rewards all users of the PointCoin network as a result "
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PointCoin address or malformed URI parameters."));
    }
