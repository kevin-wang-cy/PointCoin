    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(
                      tr("Enter a PointCoin address (e.g. brj6Q4FUHXjAzCRb6SB3pXPfuva5xrfjgHY)"));
    ...
    ui->comboCurrency->addItem(COLOR_NAME[PNTS_COLOR_XPP],
                               (int) PNTS_COLOR_XPP);
...
void SendCoinsDialog::setModel(WalletModel *model)
{
    ...
    if(model && model->getOptionsModel())
    {
        ...
        connect(model->getOptionsModel(), SIGNAL(displayUnitChangedPointCoin(int)), this, SLOT(updateDisplayUnit()));
        connect(model->getOptionsModel(), SIGNAL(defaultColorChanged(int)), this, SLOT(currencyChanged(int)));

        // Coin Control
        connect(model->getOptionsModel(), SIGNAL(displayUnitChangedPointCoin(int)), this, SLOT(coinControlUpdateLabels()));
        connect(model->getOptionsModel(), SIGNAL(coinControlFeaturesChanged(bool)), this, SLOT(coinControlFeatureChanged(bool)));
        connect(model->getOptionsModel(), SIGNAL(transactionFeeChangedPointCoin(qint64)), this, SLOT(coinControlUpdateLabels()));
...
void SendCoinsDialog::setChangeAddressPlaceholderText(int nColor)
{
    ...
    case PNTS_COLOR_XPP:
        ...
        /* Do not move this to the XML file, Qt before 4.7 will choke on it */
        ui->lineEditCoinControlChange->setPlaceholderText(
                    tr("Enter a PointCoin address (e.g. bxMpqqmeKUFfFeVYJn3iHK9UvjdhApUrcNq)"));
#endif
        break;
    default:
