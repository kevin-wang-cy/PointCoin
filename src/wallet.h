...
{
private:
    bool SelectCoinsSimple(int64_t nTargetValue, int nColor, unsigned int nSpendTime, int nMinConf, std::set<std::pair<const CWalletTx*,unsigned int> >& setCoinsRet, int64_t& nValueRet, bool fMultiSig) const;
    bool SelectCoins(int64_t nTargetValue, int nColor, unsigned int nSpendTime, std::set<std::pair<const CWalletTx*,unsigned int> >& setCoinsRet, int64_t& nValueRet, bool fMultiSig, const CCoinControl *coinControl=NULL) const;
...
public:
    ...
    void AvailableCoins(int nColor, std::vector<COutput>& vCoins, bool fMultiSig, bool fOnlyConfirmed=true, const CCoinControl *coinControl=NULL) const;
    // no color check because vCoins is already populated with coins of the same color!!
    bool SelectCoinsMinConf(int64_t nTargetValue, unsigned int nSpendTime, int nConfMine, int nConfTheirs, std::vector<COutput> vCoins, std::set<std::pair<const CWalletTx*,unsigned int> >& setCoinsRet, int64_t& nValueRet, bool fMultiSig) const;
